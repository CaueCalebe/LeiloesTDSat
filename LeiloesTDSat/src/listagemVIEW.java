...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    // Funcionalidade 4: botão Vender chama venderProduto() e atualiza a lista
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        String idTexto = id_produto_venda.getText().trim();
        if (idTexto.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(null, "Digite o ID do produto a ser vendido!");
            return;
        }
        try {
    ...
    // Funcionalidade 5: botão Consultar Vendas abre a vendasVIEW
